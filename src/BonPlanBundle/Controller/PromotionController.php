...
class PromotionController extends Controller
{
    ...
    public function listPromotionAdminAction()
    {
        ...
        if (($authChecker->isGranted('ROLE_SUPER_ADMIN'))){
            ...
            return $this->render('BonPlanBundle:Default:PromotionAdmin.html.twig', array('promo' => $promotion));}
    ...
    public function listPromotionVisiteurAction()
    {
        ...
        return $this->render('BonPlanBundle:Default/Promotion:ListePromoDiv.html.twig', array('promo' => $promotion));
    ...
    public function listPromotionPropAction()
    {
        ...
        return $this->render('@BonPlan/Default/Promotion/ListePromotion.html.twig', array('promo' => $promotion));
       ...
       // if (($authChecker->isGranted('ROLE_PROPRIETAIRE')))
        {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect($this->generateUrl('Ajouter_Promotion'));
            }
        ...
        public function create_PrmotionAction(Request $request)
    {
        ...
        return $this->render('@BonPlan/Default/Ajouter_Promotion.html.twig', array(
            "form"=>$form->createView()
        ));}
    public function PromotionAction()
    {
        return $this->render('BonPlanBundle:Default:ListePromotion.html.twig');
    }
    ...
    public function addPromoAction(Request $request)
    {
        ...
        if (($authChecker->isGranted('ROLE_PROP')))
        {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect($this->generateUrl('bon_plan_homepage_back'));
            }
    ...
    public function UpdatePromotion1Action(Request $request, $id)
    {
        ...
        if($form->isSubmitted())
        {
           ...
           // $promotion =$em->getRepository(Promotion::class)->findByidUser($this->getUser());
            return $this->redirect($this->generateUrl('liste_Promotion'));
        }
    ...
    public function deletePromotionAction(Request $request)
    {
        ...
        return $this->redirectToRoute('liste_Promotion');
    ...
    public function RechercheAction(Request $request)
    {
        ...
        $en = $this->getDoctrine()->getManager();
        $promotion=$en->getRepository("BonPlanBundle:Promotion")->findDescription($search);
        return $this->render("BonPlanBundle:Default/Promotion:ListePromotion.html.twig",array(
            'promo' => $promotion
